...
class Pcode(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.addProject(startWindow, "Start",
                        "Start", "Resources\\images\\flag-green")
    ...
    def createActions(self):
        ...
        self.settingsAct = QtGui.QAction(
            QtGui.QIcon("Resources\\images\\config"),
            "Settings", self,
    ...
    def addProject(self, window, name, type='Project', iconPath=None):
        ...
        if type == 'Project':
            self.projectTitleBox.insertItem(0, QtGui.QIcon(
                "Resources\\images\\project"), name, [window, type])
        else:
            self.projectTitleBox.insertItem(0, QtGui.QIcon(
...
splash = QtGui.QSplashScreen(QtGui.QPixmap("Resources\\images\\splash"))
splash.show()
