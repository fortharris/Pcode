...
class EnvBuilder:
    ...
    *un*available to the created environment.
    ...
    def __init__(self, installed_python_path, system_site_packages=False, clear=False,
                 symlinks=False, upgrade=False):
        self.system_site_packages = system_site_packages
        self.clear = clear
        self.symlinks = symlinks
        self.upgrade = upgrade
        self.installed_python_path = installed_python_path
    ...
    def ensure_directories(self, env_dir):
        ...
        env = os.environ
        dirname, exename = os.path.split(os.path.abspath(self.installed_python_path))
        context.executable = self.installed_python_path
    ...
    def setup_scripts(self, context):
        ...
        path = os.path.join(path, 'Resources', 'venv', 'scripts')
