...
class Start(QtGui.QLabel):
    ...
    def __init__(self, useData,  parent):
        ...
        label.setPixmap(QtGui.QPixmap("Resources\\images\\compass"))
        hbox.addWidget(label)
        ...
        openButton.setIcon(QtGui.QIcon("Resources\\images\\wooden-box"))
        openButton.clicked.connect(self.openProject)
        hbox.addWidget(openButton)

        newButton = QtGui.QPushButton("New Project")
        newButton.setIcon(QtGui.QIcon("Resources\\images\\inbox--plus"))
        ...
        homePageButton.setIcon(QtGui.QIcon("Resources\\images\\Web"))
